classdef ShadingCorrector_mean < ShadingCorrector_smooth
    %ShadingCorrector_mean Shading corrected which smooths the
    %reference images using k nearest means
    ...
    methods
        ...
        %CONSTRUCTOR
        %Call superclass
        function this = ShadingCorrector_mean(reference_image_array)
        ...
        function smoothPanel(this,index,corner_position,p)
            ...
            panel_image = imboxfilt(panel_image,p);            
