...
classdef Experiment_GlmMse_Mar16 < Experiment_GlmMse
    ...
    methods (Access = public)
        ...
        %CONSTRUCTOR
        function this = Experiment_GlmMse_Mar16()
            %call superclass with experiment name
            this@Experiment_GlmMse('GlmMse_Mar16');
        end
    ...
    methods (Access = protected)
        ...
        function setup(this)
            ...
            this.setup@Experiment_GlmMse(20, RandStream('mt19937ar','Seed',uint32(176048084)));
        end
