classdef Experiment_MeanVarFit_July16 < Experiment_MeanVarFit
    ...
    methods (Access = public)
        ...
        %CONSTRUCTOR
        function this = Experiment_MeanVarFit_July16(experiment_name)
            %call superclass with experiment name
            this@Experiment_MeanVarFit(experiment_name);
        end
