...
\begin{figure*}
  ...
  \caption{Timings when filtering a $256\times 256$ image. The mean variance null filter uses the sample mean and sample standard deviation to locally normalise the image. Note the y-axis change scale.}
