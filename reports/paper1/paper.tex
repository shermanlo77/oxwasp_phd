...
The empirical null filter catered for inaccuracies made by \emph{aRTist} and voids in the order of millimetres were detectable. This demonstrated that the filter can adjust the null hypotheses according to the data to make sensible inference. In the experiments, it was found that the FDR level is preserved after filtering.
