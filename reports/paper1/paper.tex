...
\begin{figure*}
  ...
  \caption{Timings when filtering a $256\times 256$ image. The mean variance null filter uses the sample mean and sample standard deviation to locally normalise the image. Note that the $y$-axis changes scale. The box plot summarise 100 repeated measurements of the timings.}
