  ...
  \centering
    \centerline{
      \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=1.05\textwidth, height=4.9cm]{../figures/inference/DefectDetectSubRoiAbsFilterDeg120_radius4_sigBW.eps}
        \caption{X-ray projection with positive pixels}
      \end{subfigure}
      \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/inference/DefectDetectSubRoiAbsFilterDeg120_radius4_logpBW.eps}\vspace{-1mm}
        \caption{$-\log p$}
      \end{subfigure}
    }
    \centerline{
