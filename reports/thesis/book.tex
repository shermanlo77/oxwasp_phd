...
The saddlepoint approximation was computed up to a constant using
\begin{equation}
...
\begin{equation}
k = \max_{i\in\text{simulation}}\left[
...
A Q-Q plot is a plot which compares the empirical with the theoretical c.d.f. Suppose realizations of $X$ were simulated $\left\{x_1,x_2,x_3,\dotdotdot,x_n\right\}$, let
\begin{equation}
