...
\centering
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noiseidentity_order_1.eps}
        \caption{Identity, feature order 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noisecanonical_order_-1.eps}
        \caption{Canonical, feature order -1}
    \end{subfigure}
    }
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noisecanonical_order_-2.eps}
        \caption{Canonical, feature order -2}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noiselog_order_-1.eps}
        \caption{Log, feature order -1}
    \end{subfigure}
    }
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noisecanonical_order_-2.eps}
        \caption{Log, feature order -2}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/noise1000_NN.eps}
        \caption{1000-NN}
    \end{subfigure}
    }
\end{figure}
...
\centering
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/mseidentity_order_1.eps}
        \caption{Identity, feature order 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/msecanonical_order_-1.eps}
        \caption{Canonical, feature order -1}
    \end{subfigure}
    }
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/msecanonical_order_-2.eps}
        \caption{Canonical, feature order -2}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/mselog_order_-1.eps}
        \caption{Log, feature order -1}
    \end{subfigure}
    }
    \centerline{
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/mse1000_NN.eps}
        \caption{1000-NN}
    \end{subfigure}
    }
\end{figure}
...
\centering
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/biasidentity_order_1.eps}
        \caption{Identity, feature order 1}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/biascanonical_order_-1.eps}
        \caption{Canonical, feature order -1}
    \end{subfigure}
    }
    \centerline{
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/biascanonical_order_-2.eps}
        \caption{Canonical, feature order -2}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/biaslog_order_-1.eps}
        \caption{Log, feature order -1}
    \end{subfigure}
    }
    \centerline{
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{../figures/bias1000_NN.eps}
        \caption{1000-NN}
    \end{subfigure}
    }
\end{figure}
