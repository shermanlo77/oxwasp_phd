...
%\end{equation*}
%\begin{equation*}
%j=1,2,3,\dotdotdot,n_{repeat}
%\end{equation*}
%\begin{equation*}
%x_i^{(j)} = \text{mean greyvalue of pixel }i\text{, }j\text{th repeat}
%\end{equation*}
%\begin{equation*}
%y_i^{(j)} = \text{variance greyvalue of pixel }i\text{, }j\text{th repeat}
%\end{equation*}
%\begin{equation*}
%\widehat{Y}^{(j)}(x) = \text{predicted variance greyvalue given }x
%\end{equation*}
%Trained $\widehat{Y}^{(j)}(x)$ using $(y_1^{(j)},x_1^{(j)}),(y_2^{(j)},x_2^{(j)}),(y_3^{(j)},x_3^{(j)}),\dotdotdot,(y_{n_{pixel}}^{(j)},x_{n_{pixel}}^{(j)})$.
%\begin{equation*}
%\widehat{\zeta}^{(j)}(x) = \text{predicted variance of the variance greyvalue given }x
%\end{equation*}
%
%Below are the training statistics, but can be generalised to test statistics:
%\begin{equation}
%\text{MSE}^{(j)} = \sum_{i=1}^{n_{pixel}} \left[\widehat{Y}^{(j)}(x_i^{(j)}) - y_i^{(j)}\right]^2
%\end{equation}
%\begin{equation}
%\text{MSSE}^{(j)} = \sum_{i=1}^{n_{pixel}} \left[\dfrac{\widehat{Y}^{(j)}(x_i^{(j)}) - y_i^{(j)}}{\sqrt{\widehat{\zeta}^{(j)}(x_i^{(j)})}}\right]^2
%\end{equation}
%\begin{equation}
%\text{VAR}^{(j)} = \sum_{i=1}^{n_{pixel}}
%\left[
%\widehat{Y}^{(j)}(x_i^{(j)}) - \expectation(\widehat{Y}(x_i^{(j)}))
%\right]^2
%\end{equation}
%\begin{equation}
%\text{BIAS2}^{(j)} = \sum_{i=1}^{n_{pixel}}
%\left[
%\expectation(\widehat{Y}(x_i^{(j)}))
%-
%y_i^{(j)}
%\right]^2
%\end{equation}
%where
%\begin{equation}
%\expectation(\widehat{Y}(x_i^{(j)})) \approx
%\frac{1}{n_{repeat}}\sum_{j=1}^{n_{repeat}}
%\widehat{Y}^{(j)}(x_i^{(j)})
%\end{equation}
%
%\clearpage
...
%(\widehat{Y}(x) - \expectation(\widehat{Y}(x))^2
%\right]
%\end{equation}
%\begin{equation}
%\text{BIAS2}(x) = \expectation\left[
%(\expectation(\widehat{Y}(x) - y(x))^2
%\right]
%\end{equation}
%\begin{equation}
...
%\end{equation}
%
%$y(x)$ is unknown so the bias squared can be calculated using
%\begin{equation}
%\text{BIAS2}(X) = \text{MSE}(X) - \text{VAR}(X) - \sigma^2(x)
%\end{equation}
%
%The expectations were estimated using bootstrapped samples of $Y(x)$ and $\widehat{Y}(x)$.
%
%\clearpage
%
%\begin{figure}
...
%    \centerline{
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/training_MSSE.eps}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/test_MSSE.eps}
%    \end{subfigure}
%    }
%    \caption{Mean squared standardised error}
%\end{figure}
%
%\begin{figure}
%\centering
%    \centerline{
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/training_MSE.eps}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/test_MSE.eps}
%    \end{subfigure}
%    }
...
%    \centerline{
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/training_var.eps}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/test_var.eps}
%    \end{subfigure}
%    }
%    \caption{Estimation variance}
%\end{figure}
%
%\begin{figure}
%\centering
%    \centerline{
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/training_bias2.eps}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.49\textwidth}
%        \includegraphics[width=\textwidth]{../figures/test_bias2.eps}
%    \end{subfigure}
%    }
%    \caption{Bias squared}
%\end{figure}
