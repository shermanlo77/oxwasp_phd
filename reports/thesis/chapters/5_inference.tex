...
\begin{figure}[p]
	\centering
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../figures/inference/noContamination/unfiltered.eps}
		\caption{Unfiltered}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../figures/inference/noContamination/filtered.eps}
		\caption{Filtered}
	\end{subfigure}
	\caption{A $\addNumber{../figures/inference/noContamination/imageSize.txt} \times \addNumber{../figures/inference/noContamination/imageSize.txt}$ Gaussian image before and after filtering with kernel radius \addNumber{../figures/inference/noContamination/radius.txt}.}
...
\begin{figure}[p]
	\centering
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../figures/inference/noContamination/nullmean.eps}
		\caption{Empirical null mean}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
		\includegraphics[width=\textwidth]{../figures/inference/noContamination/nullstd.eps}
		\caption{Empirical null std}
	\end{subfigure}
	\caption{The empirical null parameters when filtering a $\addNumber{../figures/inference/noContamination/imageSize.txt} \times \addNumber{../figures/inference/noContamination/imageSize.txt}$ Gaussian image with a kernel radius of \addNumber{../figures/inference/noContamination/radius.txt}.}
	\label{fig:inference_noContamination_nullimages}
\end{figure}
