...
\begin{figure}
    ...
    \caption{The $p$-values and significant pixels when using the empirical null filter on an $z$ image where the ground truth was contaminated by a plane with gradient 7.0.}
...
\begin{figure}
    ...
    \caption{The $p$-values and significant pixels when using the empirical null filter on an $z$ image where the ground truth was contaminated by a sinusoid with amplitude $10^4$.}
