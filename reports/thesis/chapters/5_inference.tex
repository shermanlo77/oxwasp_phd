...
The empirical null was used to correct the test statistics $z_1,z_2,\cdots,z_n$ to $\zeta_1,\zeta_2,\cdots,\zeta_n$ by standardising the test statistics
\begin{equation}
  \zeta_i = \dfrac{
    z_i - \widehat{\mu}_0
  }
...
\end{equation}
where $b$ and $a$ are parameters to be fitted. Figure \ref{fig:inference_BandwidthSelection2_ruleOfThumb} show the fitting of an identity link gamma GLM in order to estimate $b$ and $a$. The estimated parameters are shown in Table \ref{table:inference_BandwidthSelection2_ruleOfThumb}.
