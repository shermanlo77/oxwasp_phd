...
In terms of the area under the ROC curves, the empirical null filter improves the performance over using the unfiltered contaminated image. Not as good as the uncontaminated image but it is an improvement. For kernel radiuses too small, such as Figure \ref{fig:inference_defectSimulationRoc_square20}, the empirical null filter deteriorates the performance dramatically and it would be better off using the contaminated image.