...
\end{tabular}
\caption{Forward stepwise selection was used to find suitable polynomial orders when fitting a GLM onto the sample variance-mean data of the grey values from the projections in \texttt{AbsNoFilter} at \ang{30}. The columns of the table represent different shading corrections used on the projections. Forward stepwise selection was repeated 10 times by using a different random permutation with replacement to obtain a different sample variance-mean data. The row labelled order shows the most common selected polynomial orders. The error bars are the standard deviation from the 10 repeats.}
...
\end{tabular}
\caption{Forward stepwise selection was used to find suitable polynomial orders when fitting a GLM onto the sample variance-mean data of the grey values from the projections in \texttt{AbsNoFilter} at \ang{120}. The columns of the table represent different shading corrections used on the projections. Forward stepwise selection was repeated 10 times by using a different random permutation with replacement to obtain a different sample variance-mean data. The row labelled order shows the most common selected polynomial orders. The error bars are the standard deviation from the 10 repeats.}
...
\end{tabular}
\caption{Forward stepwise selection was used to find suitable polynomial orders when fitting a GLM onto the sample variance-mean data of the grey values from the projections in \texttt{AbsFilter} at \ang{30}. The columns of the table represent different shading corrections used on the projections. Forward stepwise selection was repeated 10 times by using a different random permutation with replacement to obtain a different sample variance-mean data. The row labelled order shows the most common selected polynomial orders. The error bars are the standard deviation from the 10 repeats.}
...
\begin{figure}
  \centering
    ...
    \begin{subfigure}[b]{\subSize}
        ...
        \caption{$\widehat{y}(x)=\beta_0+\beta_1 x$ at \ang{30}}
    \end{subfigure}
    \begin{subfigure}[b]{\subSize}
        \includegraphics[width=\textwidth]{../figures/varmean/varMeanExample_AbsNoFilterDeg30_reciprocal000100.eps}
        \caption{$\widehat{y}(x)=(\beta_{-1}x^{-1}\beta_0)^{-1}$ at \ang{30}}
    \end{subfigure}
    }
    \centerline{
    \begin{subfigure}[b]{\subSize}
        \includegraphics[width=\textwidth]{../figures/varmean/varMeanExample_AbsNoFilterDeg120_identity000010.eps}
        \caption{$\widehat{y}(x)=\beta_0+\beta_1 x$ at \ang{120}}
    \end{subfigure}
    \begin{subfigure}[b]{\subSize}
        \includegraphics[width=\textwidth]{../figures/varmean/varMeanExample_AbsNoFilterDeg120_reciprocal000100.eps}
        \caption{$\widehat{y}(x)=(\beta_{-1}x^{-1}\beta_0)^{-1}$ at \ang{120}}
    \end{subfigure}
    }
    \caption{Log frequency density histogram of the sample variance-mean data from \texttt{AbsNoFilter} with linear shading correction. The red solid line shows the GLM fit along with $\Phi(\pm 1)$ prediction interval as dashed lines.}
...
\begin{figure}
  \centering
    ...
    \begin{subfigure}[b]{\subSize}
        ...
        \caption{$\widehat{y}(x)=\beta_{-1}x^{-1}+\beta_0$ at \ang{30}}
    \end{subfigure}
    \begin{subfigure}[b]{\subSize}
    ...
    \caption{Log frequency density histogram of the sample variance-mean data from \texttt{AbsFilter} with linear shading correction. The red solid line shows the GLM fit along with $\Phi(\pm 1)$ prediction interval as dashed lines.}
...
\begin{figure}
  ...
  \caption{Log frequency density histogram of the residuals given the mean grey value. The residuals are from fitting a gamma GLM of the form $\widehat{y}(x)=\beta_0+\beta_1 x$ onto the sample variance-mean data obtained from the replicated projections. The dashed red line shows the $\Phi(\pm 1)$ predicted residual interval.}
...
\begin{figure}
  ...
  \caption{Absolute value residuals from fitting a gamma GLM of the form $\widehat{y}(x)=\beta_0+\beta_1 x$ onto the sample variance-mean data obtained from the replicated projections. Highlighted in a red box is an inflection.}
...
Various parametric models were investigated. A gamma GLM with identity and canonical link functions were looked at with different explanatory polynomials. In terms of cross-validation, most of the models looked at have similar prediction performance when predicting the variance given a grey value. Thus the relationship $\widehat{y}(x)=\beta_0+\beta_1 x$ using the identity link is attractive for its simplicity and links with the compound Poisson model.
