...
\begin{figure}
  \centering
    ...
    \caption{Log frequency density histogram of the sample variance-mean data from \texttt{AbsNoFilter} with linear shading correction. The solid red line shows the GLM fit along with the 95\% prediction interval as dashed lines.}
...
\begin{figure}
  \centering
    ...
    \caption{Log frequency density histogram of the sample variance-mean data from \texttt{AbsFilter} with linear shading correction. The solid red line shows the GLM fit along with the 95\% prediction interval as dashed lines.}
...
\begin{figure}
  ...
  \caption{Log frequency density histogram of the residuals given the mean grey value. The residuals are from fitting a gamma GLM of the form ${y}(x)=\beta_0+\beta_1 x$ onto the sample variance-mean data obtained from the replicated projections. The dashed red line shows the 95\% confidence interval of the predicted residual.}
