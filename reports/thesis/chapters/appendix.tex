...
\begin{align}
  ...
  \ .
\end{align}
But because $U_i$ for $i=1,2,3,\dotdotdot$ are i.i.d., then each $U_i$ has a common m.g.f.~$M_U(\theta)=\expectation\left[\euler^{U\theta}\right]$ and
\begin{align}
...
\begin{align*}
  ...
  \phi^{\frac{1}{1-p}}
  \cdot
  \dfrac{1}{1-p}\cdot\theta^{\frac{p}{1-p}}
  \cdot
  (1-p)^\frac{p}{1-p} \ .
\end{align*}
