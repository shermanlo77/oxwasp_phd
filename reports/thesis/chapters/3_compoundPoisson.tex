...
\begin{figure}
  \centering
    ...
    \caption{1\,000 $\CPoisson(1,1,1)$ random variables were simulated and its empirical distribution is compared to the p.d.f.~evaluated using the exact method. In a), the dotted red line shows the $\Phi(\pm1)$ quantile of the expected frequency or frequency density.}
...
\begin{figure}
  \centering
    ...
    \caption{1\,000 $\CPoisson(1,100,1)$ random variables were simulated and its empirical distribution is compared to the p.d.f.~evaluated using the exact method. In a), the dotted red line shows the $\Phi(\pm1)$ quantile of the expected frequency or frequency density.}
...
\begin{figure}
  \centering
    ...
    \caption{1\,000 $\CPoisson(1,\alpha,1)$ random variables were simulated and its empirical distribution is compared to the p.d.f.~evaluated using approximate methods. The dotted red line shows the $\Phi(\pm1)$ quantile of the expected frequency density.}
...
\begin{figure}
  \centering
    ...
    \caption{1\,000 $\CPoisson(10,1,1)$ random variables were simulated and its empirical distribution is compared to the p.d.f. On the left, the dotted red line shows the $\Phi(\pm1)$ quantile of the expected frequency density.}
...
\begin{figure}
  \centering
    ...
    \caption{1\,000 $\CPoisson(100,100,1)$ random variables were simulated and its empirical distribution is compared to the p.d.f. On the left, the dotted red line shows the $\Phi(\pm1)$ quantile of the expected frequency density.}
