...
Most of the calculations for the elements of the matrix are similar to the derivatives of $T$. For the $\alpha$ component, taking derivatives of the joint log-likelihood (Equation \eqref{eq:compoundPoisson_jointLogLikelihood}) obtains
\begin{align}
...
Fisher's information matrix is
\begin{multline}
  \matr{I}=
  n
  \left(\begin{matrix}
...
\begin{figure}[p]
  \centering
    ...
    \caption{The EM algorithm was used to estimate the parameters of a $\CPoisson(1,1,1)$ random variable using 1\,000 simulated samples. The graphs show the log-likelihood and the estimated parameters at each EM step for 10 different simulations. The dashed lines show the standard deviation using the Cram\'er-Rao lower bound.}
...
\begin{figure}[p]
  \centering
    ...
    \caption{The EM algorithm was used to estimate the parameters of a $\CPoisson(1,100,1)$ random variable using 1\,000 simulated samples. The graphs show the log-likelihood and the estimated parameters at each EM step for 10 different simulations. The dashed lines show the standard deviation using the Cram\'er-Rao lower bound.}
...
\begin{figure}[p]
  \centering
    ...
    \caption{The EM algorithm was used to estimate the parameters of a $\CPoisson(10,1,1)$ random variable using 1\,000 simulated samples. The graphs show the log-likelihood and the estimated parameters at each EM step for 10 different simulations. The dashed lines show the standard deviation using the Cram\'er-Rao lower bound.}
...
\begin{figure}[p]
  \centering
    ...
    \caption{The EM algorithm was used to estimate the parameters of a $\CPoisson(100,100,1)$ random variable using 1\,000 simulated samples. The graphs show the log-likelihood and the estimated parameters at each EM step for 10 different simulations. The dashed lines show the standard deviation using the Cram\'er-Rao lower bound.}
