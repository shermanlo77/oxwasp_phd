...
\section{Conclusion}
The compound Poisson-gamma distribution was studied but it was found there were identifiability issues when fitting the model onto simulated data, in particular for high $\lambda$. It was found that the log-likelihood was quite flat because, by using numerous approximations, it was found that the determinant of the Hessian is zero. This cast doubts if a unique maximum likelihood estimator exists. Tighter bounds for the Hessian is beyond the scope of this thesis.
